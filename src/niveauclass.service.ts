...
export class NiveauClassService {
    ...
    async createNiveauClass(data: Prisma.NiveauClassCreateInput): Promise<NiveauClass> {
    ...
    async updateNiveauClass(params: {
      ...
      // Delete NiveauClass
      async deleteNiveauClass(where: Prisma.NiveauClassWhereUniqueInput): Promise<NiveauClass> {
