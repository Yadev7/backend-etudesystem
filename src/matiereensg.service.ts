...
export class MatiereEnsgService {
    ...
    async createMatiereEnsg(data: Prisma.MatiereEnsgCreateInput): Promise<MatiereEnsg> {
    ...
    // Delete MatiereEnsg
    async deleteMatiereEnsg(where: Prisma.MatiereEnsgWhereUniqueInput): Promise<MatiereEnsg> {
